    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>TAMBAH BUKU BARU</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="title" class="col-sm-3 control-label">JUDUL BUKU</label>
                ...
                <div class="form-group">
                    <label for="category" class="col-sm-3 control-label">KATEGORI BUKU</label>
                ...
                <div class="form-group">
                    <label for="author" class="col-sm-3 control-label">PENULIS BUKU</label>
                ...
                <div class="form-group">
                    <label for="publisher" class="col-sm-3 control-label">PENERBIT BUKU</label>
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">TANGGAL TERBIT</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_title" class="col-sm-3 control-label">JUDUL BUKU</label>
                ...
                <div class="form-group">
                    <label for="edit_author" class="col-sm-3 control-label">PENULIS BUKU</label>
                ...
                <div class="form-group">
                    <label for="edit_publisher" class="col-sm-3 control-label">PENERBIT BUKU</label>
                ...
                <div class="form-group">
                    <label for="datepicker_edit" class="col-sm-3 control-label">TANGGAL TERBIT</label>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> TUTUP</button>
            	<button type="submit" class="btn btn-danger btn-flat" name="delete"><i class="fa fa-trash"></i> SIMPAN</button>
            	</form>
          	</div>
        </div>
    </div>
